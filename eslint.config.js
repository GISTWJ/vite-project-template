...
export default [
  ...
  // Vue 文件配置
  {
    ...
    rules: {
      ...
      "vue/no-this-in-template": "error", // 禁止模板中的 this
      ...
      "vue/require-directive": "error", // 要求指令
      "vue/require-prop-type-constructor": "error", // 要求 prop 类型构造函数
      "vue/require-render-return": "error", // 要求 render 函数返回值
      "vue/require-toggle-inside-transition-group": "error", // 要求 transition-group 内的切换
      ...
      "vue/v-on-function-call": ["error", "never"], // v-on 函数调用
